...
export default function ExperiencePage({
  ...
  const milestones: MilestoneItem[] = [
    ...
    },
    {
      ...
      image: "/assets/the_learning_institute.jpg",
      icon: BookOpen,
    ...
    },
    {
      ...
      image: "/assets/kalyani_charitable_trust_nashik.jpeg",
      icon: Sparkles,
    ...
    },
    {
      ...
      image: "/assets/nh_goel_world_school_raipur.jpg",
      icon: Flame,
    ...
    },
    {
      ...
      image: "/assets/kaanger_valley_academy_raipur.jpg",
      icon: GraduationCap,
